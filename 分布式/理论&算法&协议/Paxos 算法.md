...
![img](/assets/paxos-made-simple.64103a59.png)
...
由于 Paxos 算法在国际上被公认的非常难以理解和实现，因此不断有人尝试简化这一算法。到了2013 年才诞生了一个比 Paxos 算法更易理解和实现的共识算法—[Raft 算法open in new window](https://javaguide.cn/distributed-system/theorem&algorithm&protocol/raft-algorithm.html) 。更具体点来说，Raft 是Multi-Paxos的一个变种，其简化了 Multi-Paxos 的思想，变得更容易被理解以及工程实现。
...
## [#](#一致性-consistency-与共识-consensus) 一致性（Consistency）与共识（Consensus）
...
![img](https://img-blog.csdnimg.cn/20210603145613753.png)
