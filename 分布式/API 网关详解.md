...
我们可以自定义过滤器来处理请求，并且，Zuul 生态本身就有很多现成的过滤器供我们使用。就比如限流可以直接用国外朋友写的 [spring-cloud-zuul-ratelimitopen in new window](https://github.com/marcosbarbero/spring-cloud-zuul-ratelimit) (这里只是举例说明，一般是配合 hystrix 来做限流)：
...
Kong 是一款基于 [OpenRestyopen in new window](https://github.com/openresty/) 的高性能、云原生、可扩展的网关系统。
...
- [有了 NGINX 和 Kong，为什么还需要 Apache APISIXopen in new window](https://www.apiseven.com/zh/blog/why-we-need-Apache-APISIX)
- [APISIX 技术博客open in new window](https://www.apiseven.com/zh/blog)
- [APISIX 用户案例open in new window](https://www.apiseven.com/zh/usercases)
