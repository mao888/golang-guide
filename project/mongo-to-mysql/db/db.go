...
func init() {
	...
	//dsnCruiser := "root:Redhat@123@(192.168.1.52:3306)/cruiser_console?charset=utf8mb4&parseTime=True&loc=Local"
	////dsn := "root:EBc3lHqqzR5F2tt2@(rm-2ze030tf526174x36.mysql.rds.aliyuncs.com:3306)/application_console?charset=utf8mb4&parseTime=True&loc=Local"
	//dbCruiser, err := gorm.Open(mysql.Open(dsnCruiser), &gorm.Config{})
	//if err != nil {
	//	fmt.Println(err)
	//}
	//MySQLClientCruiser = dbCruiser
