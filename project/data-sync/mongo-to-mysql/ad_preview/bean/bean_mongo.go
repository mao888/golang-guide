...
// MAdFlowCfg 素材 From Mongo/cruiser_console_v2/adflowcfg
type MAdFlowCfg struct {
	...
	LanguageGroups []struct {    // 年龄组 [{ name: '国家组名称', languages: ['en', 'zh'] }]
		Name      string `json:"name"`
		NoLimit   bool   `json:"no_limit"`
		Languages int    `json:"languages"`
	} `json:"language_groups" bson:"language_groups"`
	Strategys []struct {
		Target struct {
	...
	IsWifi             bool          `json:"is_wifi" bson:"is_wifi"`
	VerMin             string        `json:"ver_min" bson:"ver_min"`
	VerMax             interface{}   `json:"ver_max" bson:"ver_max"`
...
type MAdFlow struct {
	...
	SuccessCampaign []interface{} `json:"success_campaign" bson:"success_campaign"`
	SuccessAdset    []struct {
		Name string `json:"name" bson:"name"`
	...
	CfgFrameId   string        `json:"cfg_frame_id" bson:"cfg_frame_id"`
