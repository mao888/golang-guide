...
type MFBAdSetModel struct {
	...
	OptimizationGoal string `json:"optimization_goal" bson:"optimization_goal"` // ['APP_INSTALLS', 'VALUE', 'OFFSITE_CONVERSIONS', 'LINK_CLICKS', 'DERIVED_EVENTS', 'LANDING_PAGE_VIEWS']
