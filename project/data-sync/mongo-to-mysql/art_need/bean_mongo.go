...
type ArtAttachments struct {
	...
	Type              int        `json:"type" bson:"type"`                                                   //0: 普通附件， 1， 终稿附件
	...
	AssetWidth        int        `json:"asset_width,omitempty" bson:"asset_width,omitempty"`                 // 素材宽度
	AssetHeight       int        `json:"asset_height,omitempty" bson:"asset_height,omitempty"`               // 素材高度
	FileSize          int64      `json:"file_size,omitempty" bson:"file_size,omitempty"`                     // 1024 * 1024 * 1000 = 1M
