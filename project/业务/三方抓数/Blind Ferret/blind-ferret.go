...
type (
	BlindFerretRes struct {
		...
		CreativeID           interface{} `json:"Creative ID"`
		CreativeName         interface{} `json:"Creative Name"`
		CreativeURL          interface{} `json:"Creative URL"`
...
func main() {
	...
	glog.Infof(ctx, "blindFerretRes的长度:%d", blindFerretRes)
}
