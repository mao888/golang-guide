...
### [#](#静态资源是如何被缓存到-cdn-节点中的) 静态资源是如何被缓存到 CDN 节点中的？
...
### [#](#如何找到最合适的-cdn-节点) 如何找到最合适的 CDN 节点？
...
![img](https://guide-blog-images.oss-cn-shenzhen.aliyuncs.com/github/javaguide/high-performance/cdn/timestamp-anti-theft.png)
