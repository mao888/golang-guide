...
### [#](#读写分离会带来什么问题-如何解决) 读写分离会带来什么问题？如何解决？
...
![水平分库](/assets/horizontal-slicing-database.53fbc43a.png)
...
![分表](/assets/two-forms-of-sub-table.3475ce44.png)
...
### [#](#分库分表有没有什么比较推荐的方案) 分库分表有没有什么比较推荐的方案？
...
艿艿之前写了一篇分库分表的实战文章，各位朋友可以看看：[《芋道 Spring Boot 分库分表入门》open in new window](https://mp.weixin.qq.com/s/A2MYOFT7SP-7kGOon8qJaw) 。
