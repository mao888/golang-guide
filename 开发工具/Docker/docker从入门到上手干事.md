...
### [#](https://javaguide.cn/tools/docker/docker-in-action.html#什么是-docker)什么是 Docker？
...
### [#](https://javaguide.cn/tools/docker/docker-in-action.html#为什么要用-docker)为什么要用 Docker?
...
![img](https://img-blog.csdnimg.cn/20210412220015698.png)

## [#](https://javaguide.cn/tools/docker/docker-in-action.html#docker-的安装)Docker 的安装

### [#](https://javaguide.cn/tools/docker/docker-in-action.html#windows)Windows

接下来对 Docker 进行安装，以 Windows 系统为例，访问 Docker 的官网：

![img](https://oscimg.oschina.net/oscnet/up-4e3146984adaee0067bdc5e9b1d757bb479.png)

然后点击`Get Started`：

![img](https://oscimg.oschina.net/oscnet/up-96adfbfebe3e59097c8ba25e55f68ba7908.png)

在此处点击`Download for Windows`即可进行下载。

如果你的电脑是`Windows 10 64位专业版`的操作系统，则在安装 Docker 之前需要开启一下`Hyper-V`，开启方式如下。打开控制面板，选择程序：

![img](https://oscimg.oschina.net/oscnet/up-73ce678240826de0f49225250a970b4d205.png)

点击`启用或关闭Windows功能`：

![img](https://oscimg.oschina.net/oscnet/up-9c7a96c332e56b9506325a1f1fdb608a659.png)

勾选上`Hyper-V`，点击确定即可：

![img](https://oscimg.oschina.net/oscnet/up-aad4a58c5e917f7185908d6320d7fb06861.png)

完成更改后需要重启一下计算机。

开启了`Hyper-V`后，我们就可以对 Docker 进行安装了，打开安装程序后，等待片刻点击`Ok`即可：

![img](https://oscimg.oschina.net/oscnet/up-62ac3c9184bdc21387755294613ff5054c6.png)

安装完成后，我们仍然需要重启计算机，重启后，若提示如下内容：

![img](https://oscimg.oschina.net/oscnet/up-3585c7d6a4632134ed925493a7d43e14a43.png)

它的意思是询问我们是否使用 WSL2，这是基于 Windows 的一个 Linux 子系统，这里我们取消即可，它就会使用我们之前勾选的`Hyper-V`虚拟机。

因为是图形界面的操作，这里就不介绍 Docker Desktop 的具体用法了。

### [#](https://javaguide.cn/tools/docker/docker-in-action.html#mac)Mac
...
### [#](https://javaguide.cn/tools/docker/docker-in-action.html#linux)Linux
...
## [#](https://javaguide.cn/tools/docker/docker-in-action.html#docker-中的几个概念)Docker 中的几个概念

在正式学习 Docker 之前，我们需要了解 Docker 中的几个核心概念：

### [#](https://javaguide.cn/tools/docker/docker-in-action.html#镜像)镜像

镜像就是一个只读的模板，镜像可以用来创建 Docker 容器，一个镜像可以创建多个容器

### [#](https://javaguide.cn/tools/docker/docker-in-action.html#容器)容器
...
### [#](https://javaguide.cn/tools/docker/docker-in-action.html#仓库)仓库
...
### [#](https://javaguide.cn/tools/docker/docker-in-action.html#总结)总结
...
## [#](https://javaguide.cn/tools/docker/docker-in-action.html#docker-初体验)Docker 初体验
...
![img](https://oscimg.oschina.net/oscnet/up-37d083cc92fe36aad829e975646b9d27fa0.png)

在左上角的搜索框中输入`MySQL`并回车：

![img](https://oscimg.oschina.net/oscnet/up-ced37002391a059754def9b3a6c2aa4e342.png)

可以看到相关 MySQL 的镜像非常多，若右上角有`OFFICIAL IMAGE`标识，则说明是官方镜像，所以我们点击第一个 MySQL 镜像：

![img](https://oscimg.oschina.net/oscnet/up-48ba3fdc99c93a96e18b929195ca8e93c6c.png)

右边提供了下载 MySQL 镜像的指令为`docker pull MySQL`，但该指令始终会下载 MySQL 镜像的最新版本。

若是想下载指定版本的镜像，则点击下面的`View Available Tags`：

![img](https://oscimg.oschina.net/oscnet/up-ed601649275c6cfe65bbe422b463c263a64.png)
...
![img](https://oscimg.oschina.net/oscnet/up-0a46effd262d3db1b613a0db597efa31f34.png)

点击控制台：

![img](https://oscimg.oschina.net/oscnet/up-60f198e0106be6b43044969d2900272504f.png)

然后点击左上角的菜单，在弹窗的窗口中，将鼠标悬停在产品与服务上，并在右侧搜索容器镜像服务，最后点击容器镜像服务：

![img](https://oscimg.oschina.net/oscnet/up-2f6706a979b405dab01bc44a29bb6b26fc4.png)
...
## [#](https://javaguide.cn/tools/docker/docker-in-action.html#docker-镜像指令)Docker 镜像指令
...
![img](https://oscimg.oschina.net/oscnet/up-559083ae80e7501e86e95fbbad25b6d571a.png)
...
![img](https://oscimg.oschina.net/oscnet/up-68394e25f652964bb042571151c5e0fd2e9.png)

若是查询的版本不存在，则结果为空：

![img](https://oscimg.oschina.net/oscnet/up-abfdd51b9ad2ced3711268369f52b077b12.png)
...
## [#](https://javaguide.cn/tools/docker/docker-in-action.html#docker-容器指令)Docker 容器指令
...
![img](https://oscimg.oschina.net/oscnet/up-bd48e20ef07b7c91ad16f92821a3dbca5b5.png)
...
![img](https://oscimg.oschina.net/oscnet/up-16d9ff4d29094681f51424ea8d0ee4fd73e.png)
...
![img](https://oscimg.oschina.net/oscnet/up-7ec71a682712e56e90490f55c32cf660fd3.png)
...
![img](https://oscimg.oschina.net/oscnet/up-fd17796322f833685ca8ead592d38581898.png)
...
![img](https://oscimg.oschina.net/oscnet/up-fca74d4350cdfebfc2b06101e1cab411619.png)

## [#](https://javaguide.cn/tools/docker/docker-in-action.html#docker-数据卷)Docker 数据卷
...
![img](https://oscimg.oschina.net/oscnet/up-8fa1b23f6ea2567b5938370e7d7f636533f.png)
...
![img](https://oscimg.oschina.net/oscnet/up-712716a8c8c444ba3a77ade8ff27e7c6cf5.png)
